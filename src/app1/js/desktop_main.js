...
/**
 * レコード一覧画面表示<br>
 * @function app.record.index.show
 * @memberof app1
...
/**
 * レコード追加編集画面表示<br>
 * @function app.record.create.show_app.record.edit.show
 * @memberof app1
 * @returns {Object} event イベントオブジェクト
 */
...
/**
 * レコード詳細画面表示<br>
 * @function app.record.detail.show
 * @memberof app1
 * @returns {Object} event イベントオブジェクト
 */
...
/**
 * レコード保存実行前<br>
 * @function app.record.create.submit_app.record.edit.submit
 * @memberof app1
 * @returns {Object} event イベントオブジェクト
 */
...
/**
 * レコード保存実行後<br>
 * @function app.record.create.submit.success_app.record.edit.submit.success
 * @memberof app1
 * @returns {Object} event イベントオブジェクト
 */
...
/**
 * ステータス変更<br>
 * @function app.record.detail.process.proceed
 * @memberof app1
 * @returns {Object} event イベントオブジェクト
 */
